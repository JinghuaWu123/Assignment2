...
dir_where_to_save <- file.path("/Users/jinghua.wu/Library/CloudStorage/OneDrive-KarolinskaInstitutet/Mac/Documents/course/Intermediate R �C Data Science and Visualization Techniques Beyond Base R/Assignment2/figures")
...
if (params$plot_volcano) {
  ...
  # ggplotly(p)
  ggsave(file.path(dir_where_to_save, "volcano_plot.png"),plot = p, width = 6, height = 4)
}
